  ...
  render() {
    return (
      <div className='info'>
        ...
        <p>If you would still like to give us something, we are planning our honeymoon to Hawaii in January.  You can use squarecash at <a href='https://cash.me/$articole' target='_blank'>cash.me/$articole</a> if you would be interested in contributing to a great trip.</p>
